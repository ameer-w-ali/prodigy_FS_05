...
const StoryList = ({ stories, userId }: { stories: StoryWithUser[]; 
    userId: string; }) => {
                ...
                {({ open }) => {
                    return (
                        <div className="flex flex-col items-center gap-2 cursor-pointer relative" >
                            ...
                            {
                                img ?
                                    (<form action={add}><button className="text-xs bg-blue-500 p-1 rounded-md text-white">Send</button></form>)
                                    :
